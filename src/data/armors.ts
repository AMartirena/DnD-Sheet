...
export const ARMORS: ArmorData[] = [
  ...
  { name: "Cota de Malha", type: "Média", bonusCA: 3, maxDex: 2, cost: "50 po", weight: "10 kg" },
  ...
  { name: "Armadura de Talas", type: "Pesada", bonusCA: 7, minStr: 15, stealthDisadv: true,  cost: "200 po", weight: "30 kg" },
